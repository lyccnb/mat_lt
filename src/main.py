...
parser.add_argument('--cuda', action='store_true', default=True, help='gpu mode')
...
# parser.add_argument('--gpu', default="cuda:0,1",help='')
...
def main(args):
    ...
    # data_loader_train = DataLoader(dataset_train, batch_size=bz, collate_fn=utils.collate_fn, num_workers=args.num_workers)
